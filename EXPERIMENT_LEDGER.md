...
| 2026-08-15 | Factorwise mean-state routing — **frozen; not yet scored** | Post-diagnostic development protocol | Route sources using 2021 validation only; describe on 2022–2023 | Student-t VAR replaces Phase2F only when both validation RMSE and CRPS improve by at least 2%; this freezes market and illiquidity to Student-t, momentum/reversal/dispersion and all volatility states to Phase2F. The later S&P score is explicitly descriptive because its panel informed the diagnostic. |
